...
tiles = {"default_wood.png^electrica_gearbox_copper_top.png", "default_wood.png^electrica_gearbox_copper_bottom.png", "default_wood.png^electrica_gearbox_copper_side.png", "default_wood.png^electrica_gearbox_copper_side.png", "default_wood.png^electrica_gearbox_copper_side.png", "default_wood.png^electrica_gearbox_wooden_side.png"},
